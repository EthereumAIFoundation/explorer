...
/**
 * JSON-RPC 2.0 factory implementation for Geai.
 */
public class JsonRpc2_0Geai extends JsonRpc2_0Admin implements Geai {

    public JsonRpc2_0Geai(Web3jService web3jService) {
        super(web3jService);
    }
