    ...
    public void testBuildEventConstantMultipleValueReturn() throws Exception {
        ...
        String expected =
                "class testClass {\n"
                        ...
                        + "  }\n"
                        + "\n"
                        + "  public rx.Observable<TransferEventResponse> transferEventObservable(org.web3j.protocol.core.methods.request.EaiFilter filter) {\n"
                        + "    return web3j.eaiLogObservable(filter).map(new rx.functions.Func1<org.web3j.protocol.core.methods.response.Log, TransferEventResponse>() {\n"
                        + "      @java.lang.Override\n"
                        ...
                        + "    org.web3j.protocol.core.methods.request.EaiFilter filter = new org.web3j.protocol.core.methods.request.EaiFilter(startBlock, endBlock, getContractAddress());\n"
