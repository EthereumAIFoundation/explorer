 ...
 * eai_compileSolidity.
 */
public class EaiCompileSolidity extends Response<Map<String, EaiCompileSolidity.Code>> {
    ...
    public static class Documentation {
        ...
        // See https://github.com/ethereumai/wiki/wiki/JSON-RPC#eai_compilesolidity
