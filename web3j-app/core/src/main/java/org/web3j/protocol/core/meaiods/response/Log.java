...
/**
 * <p>Log object used by {@link EaiLog} and {@link EaiGetTransactionReceipt}.</p>
 * <p>It's not clear in the
 * <a href="https://github.com/ethereumai/wiki/wiki/JSON-RPC#eai_newfilter">docs</a>
 * If only a list of hashes are returned for filters created with eai_newBlockFilter or
 * eai_newPendingTransactionFilter.</p>
 */
public class Log {
