 ...
 * <ul>
 * <li>eai_getBlockByHash</li>
 * <li>eai_getBlockByNumber</li>
 * <li>eai_getUncleByBlockHashAndIndex</li>
 * <li>eai_getUncleByBlockNumberAndIndex</li>
 * </ul>
 *
 * <p>See
 ...
 *
 * <p>See the following <a href="https://github.com/eaicore/parity/issues/2401">issue</a> for
 * details on additional Parity fields present in EaiBlock.</p>
 */
public class EaiBlock extends Response<EaiBlock.Block> {

    @Override
    @JsonDeserialize(using = EaiBlock.ResponseDeserialiser.class)
