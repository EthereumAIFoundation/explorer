 ...
 */
public class EaiSyncing extends Response<EaiSyncing.Result> {

    @Override
    @JsonDeserialize(using = EaiSyncing.ResponseDeserialiser.class)
    public void setResult(EaiSyncing.Result result) {
    ...
    // these fields although not present in the RPC specification are returned by Geai 1.4.10
