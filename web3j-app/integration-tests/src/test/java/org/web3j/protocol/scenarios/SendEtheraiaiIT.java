...
/**
 * Simple integration test to demonstrate sending of EtherAI between parties.
 */
public class SendEtherAIIT extends Scenario {
    ...
    public void testTransferEtherAI() throws Exception {
        ...
        Transaction transaction = Transaction.createEtherAITransaction(
    ...
    public void testTransfer() throws Exception {
        TransactionReceipt transactionReceipt = Transfer.sendFunds(
                web3j, ALICE, BOB.getAddress(), BigDecimal.valueOf(0.2), Convert.Unit.ETHERAI)
                .send();
