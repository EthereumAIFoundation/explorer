...
html_theme_options = {
    ...
    'travis_button': 'true',
    'codecov_button': 'true',
    'description': 'Lightweight Java library for integration with EthereumAI clients',
...
texinfo_documents = [
    (master_doc, 'web3j', u'web3j Documentation',
     author, 'web3j', 'Lightweight Java library for integration with EthereumAI clients.',
     'Miscellaneous'),
]
