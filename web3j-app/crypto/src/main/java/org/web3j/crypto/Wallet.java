...
/**
 * <p>EthereumAI wallet file management. For reference, refer to
 * <a href="https://github.com/ethereumai/wiki/wiki/Web3-Secret-Storage-Definition">
 * Web3 Secret Storage Definition</a> or the
 * <a href="https://github.com/ethereumai/go-ethereumai/blob/master/accounts/key_store_passphrase.go">
 * Go EthereumAI client implementation</a>.</p>
 *
 * <p><strong>Note:</strong> the Bouncy Castle Scrypt implementation
 * {@link SCrypt}, fails to comply with the following
 * EthereumAI reference
 * <a href="https://github.com/ethereumai/wiki/wiki/Web3-Secret-Storage-Definition#scrypt">
